...
export const LoginForm = ({ onSuccess }: LoginFormProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result.success && !result.requiresOtp) {
      ...
      // OTP form will show automatically
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12" style={{ backgroundColor: 'var(--bg-primary)' }}>
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-full mb-4" style={{ backgroundColor: 'var(--color-primary)/10' }}>
          ...
          <p className="mt-2" style={{ color: 'var(--text-muted)' }}>
            Sign in to continue to Qroq AI Chatbot
          </p>
        </div>
        ...
        {/* Form Card */}
        <div className="rounded-xl p-8 border" style={{ backgroundColor: 'var(--bg-surface)', borderColor: 'var(--border-color)' }}>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 rounded border-gray-600 focus:ring-2 focus:ring-chatgpt-green"
